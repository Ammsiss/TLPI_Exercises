...
int bt_create_node(BTNode **node, char *key, void *value)
{
...
int bt_add_rec(BTNode *node, char *key, void *value)
{
...
BTNode **bt_find_node(BTNode **node, char *key)
{
    BTNode **nextDirection;
...
void bt_print_rec(BTNode *node, int traversal)
{
