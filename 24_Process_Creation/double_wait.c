...
/*
   This program Is a modified version of Listing 24-6 created as a solution
   to exersise 24-5.
...
int main (void)
{
    ...
    case 0:   /* Child */
    {
        ...
        /* Child may do some work here, and then waits for parent to
        ...
        /* Child does some required actions here... */

        printf("[%s %ld] Child started - doing some work\n",
                currTime("%T"), (long) getpid());

        sleep(2);   /* Simulate time spent doing work */
    ...
    default:   /* Parent */
    {
        /* Parent does some required actions here... */
