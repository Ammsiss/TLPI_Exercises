...
**Figure 6-1**: Typical memory layout of a process on
Linux/x86-32  
**Figure 6-2**: Overview of virtual memory  
**Figure 6-3**: Example of a process stack  
**Figure 6-4**: Values of argc and argv for the command necho
hello world  
**Figure 6-5**: Example of process environment list data
structures
